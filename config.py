...
def parse_args():
    ...
    parser.add_argument("--manualFeaturesPath", default="/media/sambit/HDD/Sambit/Projects/Radiomics_Project1/Data/manual_features.csv", help="Path to csv-file containing patient numbers and manually calculated features")
    ...
    parser.add_argument("--df_nrrd", default="/media/sambit/HDD/Sambit/Projects/Radiomics_Project1/Code/Radiomics/save_files/df_nrrd.csv", help="save files")
    ...
    parser.add_argument("--testIds", default=['Pat11', 'Pat12', 'Pat13', 'Pat14'], help="Test IDs")
